...
CACHE_TTL_AI_WALLET_INSIGHTS = 3_600    # 1 hour — AI calls are expensive
CACHE_TTL_AI_TOKEN_SENTIMENT = 1_800    # 30 min
CACHE_TTL_TOKEN_SIGNAL = 300            # 5 min — rule-based, cheap to recompute
